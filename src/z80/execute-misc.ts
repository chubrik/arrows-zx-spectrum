...
const opsMisc = [
  ...
  /* ED44 NEG          */ NEG,
  /* ED45 RETN         */ RETI_RETN,
  /* ED46 IM 0         */ () => set(SYS, get(SYS) & ~IM12),
  ...
  /* ED4C NEG        * */ NEG,
  /* ED4D RETI         */ RETI_RETN,
  /* ED4E IM 0       * */ () => set(SYS, get(SYS) & ~IM12),
  ...
  /* ED54 NEG        * */ NEG,
  /* ED55 RETN       * */ RETI_RETN,
  /* ED56 IM 1         */ () => set(SYS, (get(SYS) & ~IM12) | IM1),
  /* ED57 LD A,I       */ LD_A_I,
  /* ED58 IN E,(C)     */ () => IN_c(E),
  ...
  /* ED5C NEG        * */ NEG,
  /* ED5D RETI       * */ RETI_RETN,
  /* ED5E IM 2         */ () => set(SYS, (get(SYS) & ~IM12) | IM2),
  /* ED5F LD A,R       */ LD_A_R,
  ...
  /* ED64 NEG        * */ NEG,
  /* ED65 RETN       * */ RETI_RETN,
  /* ED66 IM 0       * */ () => set(SYS, get(SYS) & ~IM12),
  /* ED67 RRD          */ RRD,
  /* ED68 IN L,(C)     */ () => IN_c(L),
  ...
  /* ED6C NEG        * */ NEG,
  /* ED6D RETI       * */ RETI_RETN,
  /* ED6E IM 0       * */ () => set(SYS, get(SYS) & ~IM12),
  /* ED6F RLD          */ RLD,
  ...
  /* ED74 NEG        * */ NEG,
  /* ED75 RETN       * */ RETI_RETN,
  /* ED76 IM 1       * */ () => set(SYS, (get(SYS) & ~IM12) | IM1),
  /* ED77 ---          */ nop,
  /* ED78 IN A,(C)     */ () => IN_c(A),
  ...
  /* ED7C NEG        * */ NEG,
  /* ED7D RETI       * */ RETI_RETN,
  /* ED7E IM 2       * */ () => set(SYS, (get(SYS) & ~IM12) | IM2),
  /* ED7F ---          */ nop,
