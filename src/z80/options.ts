...
export function fetchOptions() {
  OPTS_OP_PER_TICK = world.getSignal(optionsX, optionsY + 6) ? 1 : OP_PER_FRAME + 2; // +2 to guarantee interrupt handling
  OPTS_LIMITED_SPEED = !world.getSignal(optionsX, optionsY + 9);
}
