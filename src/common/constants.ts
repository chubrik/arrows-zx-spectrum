...
export const TSTATES_EXTRA_JR = 5;    // JR taken: 12 vs 7, charged inside JR_e
export const TSTATES_EXTRA_CALL = 7;  // CALL taken: 17 vs 10, charged inside CALL_nn
export const TSTATES_EXTRA_RET = 6;   // RET taken: 11 vs 5, charged inside RET
